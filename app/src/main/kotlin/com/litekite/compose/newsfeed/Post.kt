 ...
 */
package com.litekite.compose.newsfeed
...
private val post2 = Post(
    ...
    subtitle = """Use Dagger in Kotlin! This article includes best practices to optimize your build 
        |time and gotchas you might encounter.""".trimMargin(),
...
private val post3 = Post(
    ...
    subtitle = """Learn how to get started converting Java Programming Language code to Kotlin, 
        |making it more idiomatic and avoid common pitfalls, by…""".trimMargin(),
...
private val post5 = Post(
    ...
    subtitle = """Working with collections is a common task and the Kotlin Standard Library offers 
        |many great utility functions. It also offers two ways of…""".trimMargin(),
