 ...
 */
package com.litekite.compose.state.todo
...
/**
 * Stateless component that is responsible for the entire TodoScreen.
 *
 ...
 * @param submit (event) notify the caller that the user has submitted with
